...
const styles = StyleSheet.create({
  ...
  searchBox: { backgroundColor: '#fff', borderRadius: 8, padding: 10, fontSize: 16, marginBottom: 10, borderWidth: 1, borderColor: '#e0e0e0' },
  drawerBtn: { backgroundColor: '#1976d2', borderRadius: 8, paddingHorizontal: 20, paddingVertical: 8 },
  drawerBtnText: { color: '#fff', fontWeight: 'bold', fontSize: 15 },
